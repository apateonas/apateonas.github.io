...
const SideBar = () => (
  <section id="sidebar">
    <section id="intro">
      ...
      <header>
        <h2>Roman Dimov</h2>
        <p><a href="mailto:romanddimov@gmail.com">romanddimov@gmail.com</a></p>
      </header>
    </section>

    <section className="blurb">
      <h2>About</h2>
      <p>Hi, I&apos;m Roman. I am a <a href="https://icme.stanford.edu/">Stanford </a> student
    ...
    <section id="footer">
      <ContactIcons />
      <p className="copyright">&copy; Roman Dimov <Link to="/">www.romandimov.com</Link>.</p>
    </section>
  </section>
);
